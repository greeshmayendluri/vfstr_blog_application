...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Force a full native reload so Axios instances pull the injected Token cleanly
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[85vh] px-4 w-full">
            <div className="w-full max-w-[420px] bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-12 transition-all duration-300 hover:shadow-2xl">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm font-medium text-gray-500 mt-2">Sign in to sync with your feed.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link to="/forgot-password" className="text-xs font-bold text-indigo-600 hover:text-indigo-800 transition-colors">Forgot recovery?</Link>
                            </div>
                 ...
                 ${isLoading ? 'bg-indigo-400 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700'}`}>
                    ...
                    <div className="text-center text-sm text-gray-600 pt-6 border-t border-gray-100 mt-6 font-medium">
                        Need an account? <Link to="/register" className="font-extrabold text-indigo-600 hover:text-indigo-800 transition-colors">Register here</Link>
                    </div>
                </form>
            </div>
        </div>
